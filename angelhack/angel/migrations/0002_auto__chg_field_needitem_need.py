...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'NeedItem.need'
        db.alter_column(u'angel_needitem', 'need', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        u'angel.needitem': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'need': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True'})
        },
        u'angel.story': {
